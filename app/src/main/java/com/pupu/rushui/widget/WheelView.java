...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#ffffffff"));
            } else {
                itemView.setTextColor(Color.parseColor("#ffefefef"));
            }
        }
    }
...
//                canvas.drawLine(viewWidth * 1 / 6, obtainSelectedAreaBorder()[1], viewWidth * 5 / 6, obtainSelectedAreaBorder()[1], paint);
    ...
    public void setSeletion(int position) {
        ...
        //当前选择的文字变黑色
        ((TextView) views.getChildAt(selectedIndex)).setTextColor(Color.parseColor("#ffffffff"));
